...
const Loader: React.FC = () => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' style={{ position: 'relative', left: '50%', transform: 'translateX(-50%)' }} width='70px' height='70px' viewBox='0 0 100 100' preserveAspectRatio='xMidYMid'>
